...
class EntityTypeTagsProvider(output: FabricDataOutput, registriesFuture: CompletableFuture<HolderLookup.Provider>) :
    ...
    private fun duskTags() {
        ...
        getOrCreateTagBuilder(DuskEntityTypeTags.RACCOON_ATTACKS)
        ...
        getOrCreateTagBuilder(DuskEntityTypeTags.RACCOON_ATTACKS_MANY)
            .forceAddTag(DuskEntityTypeTags.RACCOON_ATTACKS)
            .forceAddTag(EntityTypeTags.ZOMBIES)
            .add(EntityType.CAVE_SPIDER)
            .add(EntityType.PUFFERFISH)
            .add(EntityType.MAGMA_CUBE)
        getOrCreateTagBuilder(DuskEntityTypeTags.RACCOON_RETREATS)
            .add(EntityType.WOLF)
